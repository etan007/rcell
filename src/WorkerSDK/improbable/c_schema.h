...
#define WORKER_SDK_C_INCLUDE_IMPROBABLE_C_COMMON
  ...
  * loading.
  */
 WORKERSDK_API Schema_Bundle* Schema_Bundle_Load(const uint8_t* buffer, uint32_t length);
 /**
  ...
  */
 WORKERSDK_API const char* Schema_Bundle_GetError(const Schema_Bundle* bundle);
 /** Free the resources associated with a schema bundle. */
 WORKERSDK_API void Schema_Bundle_Destroy(Schema_Bundle* bundle);

 /** Allocate a generic data object (i.e. arbitrary schema object) type instance. */
 WORKERSDK_API Schema_GenericData* Schema_CreateGenericData(void);
 /** Performs a deep copy of the source generic data object and returns the new copy. */
 WORKERSDK_API Schema_GenericData* Schema_CopyGenericData(const Schema_GenericData* source);
 /** Free the resources associated with a generic data object type instance. */
 WORKERSDK_API void Schema_DestroyGenericData(Schema_GenericData* request);
 /** Get the generic data object as a Schema_Object. */
 WORKERSDK_API Schema_Object* Schema_GetGenericDataObject(Schema_GenericData* request);

 /** Allocate a command request schema type instance. */
 WORKERSDK_API Schema_CommandRequest* Schema_CreateCommandRequest(void);
 /** Performs a deep copy of the source command request and returns the new copy. */
 WORKERSDK_API Schema_CommandRequest* Schema_CopyCommandRequest(const Schema_CommandRequest* source);
 /** Free the resources associated with a command request schema type instance. */
 WORKERSDK_API void Schema_DestroyCommandRequest(Schema_CommandRequest* request);
 /** Get the command request as a Schema_Object. */
 WORKERSDK_API Schema_Object* Schema_GetCommandRequestObject(Schema_CommandRequest* request);

 /** Allocate a command response schema type instance. */
 WORKERSDK_API Schema_CommandResponse* Schema_CreateCommandResponse(void);
 /** Performs a deep copy of the source command response and returns the new copy. */
 WORKERSDK_API Schema_CommandResponse* Schema_CopyCommandResponse(const Schema_CommandResponse* source);
 /** Free the resources associated with a command response schema type instance. */
 WORKERSDK_API void Schema_DestroyCommandResponse(Schema_CommandResponse* response);
 ...
 WORKERSDK_API void Schema_DestroyComponentData(Schema_ComponentData* data);
 /** Get the component data snapshot as a Schema_Object. */
 WORKERSDK_API Schema_Object* Schema_GetComponentDataFields(Schema_ComponentData* data);

 /** Allocate a component update schema type instance. */
 WORKERSDK_API Schema_ComponentUpdate* Schema_CreateComponentUpdate(void);
 /** Performs a deep copy of the source component update and returns the new copy. */
 WORKERSDK_API Schema_ComponentUpdate* Schema_CopyComponentUpdate(const Schema_ComponentUpdate* source);
 /** Free the resources associated with a component update schema type instance. */
 WORKERSDK_API void Schema_DestroyComponentUpdate(Schema_ComponentUpdate* update);
 /**
  ...
  */
 WORKERSDK_API Schema_Object* Schema_GetComponentUpdateFields(Schema_ComponentUpdate* update);
 /**
  ...
  */
 WORKERSDK_API void Schema_GetComponentUpdateClearedFieldList(const Schema_ComponentUpdate* update,
 ...
 WORKERSDK_API void Schema_ClearField(Schema_Object* object, Schema_FieldId field_id);
 /**
  ...
  */
 WORKERSDK_API void Schema_ShallowCopy(const Schema_Object* src, Schema_Object* dst);
 /**
  ...
  * object.
  */
 WORKERSDK_API const char* Schema_GetError(const Schema_Object* object);
 /** Returns the number of unique field IDs used in the Schema_Object. */
 WORKERSDK_API uint32_t Schema_GetUniqueFieldIdCount(const Schema_Object* object);
 /**
  ...
  */
 WORKERSDK_API void Schema_GetUniqueFieldIds(const Schema_Object* object, uint32_t* buffer);
 ...
 WORKERSDK_API void Schema_AddFloat(Schema_Object* object, Schema_FieldId field_id, float value);
 WORKERSDK_API void Schema_AddDouble(Schema_Object* object, Schema_FieldId field_id, double value);
 WORKERSDK_API void Schema_AddBool(Schema_Object* object, Schema_FieldId field_id, uint8_t value);
 WORKERSDK_API void Schema_AddInt32(Schema_Object* object, Schema_FieldId field_id, int32_t value);
 ...
 WORKERSDK_API uint32_t Schema_GetFloatCount(const Schema_Object* object, Schema_FieldId field_id);
 WORKERSDK_API uint32_t Schema_GetDoubleCount(const Schema_Object* object, Schema_FieldId field_id);
 WORKERSDK_API uint32_t Schema_GetBoolCount(const Schema_Object* object, Schema_FieldId field_id);
 WORKERSDK_API uint32_t Schema_GetInt32Count(const Schema_Object* object, Schema_FieldId field_id);
 ...
 WORKERSDK_API uint32_t Schema_GetObjectCount(const Schema_Object* object, Schema_FieldId field_id);
  ...
  *
  * Note that, for best performance, fields should be accessed in field ID order. */
 WORKERSDK_API float Schema_GetFloat(const Schema_Object* object, Schema_FieldId field_id);
 WORKERSDK_API double Schema_GetDouble(const Schema_Object* object, Schema_FieldId field_id);
 WORKERSDK_API uint8_t Schema_GetBool(const Schema_Object* object, Schema_FieldId field_id);
 WORKERSDK_API int32_t Schema_GetInt32(const Schema_Object* object, Schema_FieldId field_id);
 ...
 WORKERSDK_API const uint8_t* Schema_GetBytes(const Schema_Object* object, Schema_FieldId field_id);
 WORKERSDK_API Schema_Object* Schema_GetObject(Schema_Object* object, Schema_FieldId field_id);
  ...
  * Schema_Json_Destroy.
  */
 WORKERSDK_API const char* Schema_Json_GetJsonString(const Schema_Json* json);
 /**
  ...
  */
 WORKERSDK_API const char* Schema_Json_GetLastError(void);
 /**
  ...
  */
 WORKERSDK_API const char* Schema_Json_GetLastWarning(void);
